...
public class TN4_Q3 {
    /* args[0] = Code de produit à rechercher */
    ...
    Document doc = (Document) builder.parse("inventory.xml");
    ...
    XPathExpression expr = (XPathExpression) xpath.compile("//book[@year>2001]/title/text()");
