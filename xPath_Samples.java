/* Lire le fichier 'inventory.xml' pour pratiquer le xPath 
** xPath_samples.java - 2022-03-24 - Robert M.Vigneault
*/
...
public class xPath_Samples {
   public static void main(String[] args) throws Exception {
      ...
      nodes = (NodeList) result;
      for (int i = 0; i < nodes.getLength(); i++) {
         System.out.println("    ---> '" + nodes.item(i).getChildNodes().item(1) 
                  .getTextContent() + "'");       //node <title> is on first index
      }
